...
BULWARK_BUILDITEMS = [
    ...
    [50,   "Hedgehog",             "Land_ConcreteHedgehog_01_F",        0, 1.5],
    [50,   "Concrete single wall", "Land_CncBarrierMedium_F",           0,   3],
    ...
    [150,  "Sandbag Barricade H",  "Land_SandbagBarricade_01_hole_F",   0, 1.5],
    [150,  "Sandbag Barricade",    "Land_SandbagBarricade_01_F",        0, 1.5],
    ...
    [3000, "Watchtower",           "Land_HBarrierTower_F",            180,   3],
