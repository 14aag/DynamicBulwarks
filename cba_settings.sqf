...
force ace_hearing_earplugsVolume = 0.614972;
...
CBRN_factionMask_CIV_F_AFRICA = "";
CBRN_factionMask_CIV_F_ASIA = "";
CBRN_factionMask_CIV_F_EUROPE = "";
CBRN_factionMask_CIV_F_TANOA = "";
...
CBRN_factionMask_RWR_ru_winter = "";
